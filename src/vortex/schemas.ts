...
export const iToolStoredSchema = z.object({
  ...
  onStart: z.union([z.literal("hide"), z.literal("hide_recover"), z.literal("close")]).optional(),
...
export const iDownloadHintSchema = z.object({
  mode: z.union([z.literal("direct"), z.literal("browse"), z.literal("manual")]),
